...
:moyai: `В ноябре 2022 г.` завершил обучение на курсе ["Веб-разработчик"](https://practicum.yandex.ru/web/) в Яндекс.Практикуме. `В настоящий момент` продолжаю изучать веб-технологии, нарабатываю себе портфолио на фрилансе и параллельно ищу работу на позицию фронтенд-разработчика.
...
Подробнее обо мне [смотрите в блоге](https://pnrf.github.io/about/) :point_left: :fire:
