...
1. Прокачать свои навыки веб-разработчика и техписателя до уровня `middle+`;
2. Стать экспертом в области информационной безопасности по защите персональных данных;
3. Создать свою IT-компанию по разработке цифровых сервисов в области LegalTech.
